...
from ollama_crepe_name import generate_dungeon_fighter_crepe_name
...
def load_level(path):
    ...
    if not level_path.is_absolute():
        level_path = PROJECT_ROOT / level_path
    tmx = load_pygame(str(level_path))
...
def load_player_preview(
    ...
    if skin_name != "default":
        frame_path = ASSETS_DIR / "player" / skin_name / "player_frame1.png"
    else:
        frame_path = ASSETS_DIR / "player" / "player_frame1.png"
